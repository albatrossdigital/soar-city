...
(function($){
	...
	function getFeed(type,id,path,o,obj,opt,f1,f2,intro,feed,fn){
		...
		switch (type) {
			...
			'https://api.twitter.com/1/statuses/user_timeline.json?screen_name='+cp[0]+'&count='+n+param;
			if(cq.length > 1){
				var rts = o.retweets == false ? '+exclude:retweets' : '' ;
				url = 'https://search.twitter.com/search.json?q='+encodeURIComponent(cq[1])+rts+'&rpp='+n+'&include_entities=true&result_type=mixed';
			}
			break;
			...
			url = 'https://secure.flickr.com/services/feeds/'+fd+'.gne?id='+id+'&lang='+o.lang+'&format=json&jsoncallback=?';
			break;
			...
			url = feed == 'likes' ? 'https://api.dribbble.com/players/'+id+'/shots/likes' : 'https://api.dribbble.com/players/'+id+'/shots' ;
			break;
						...
						if(i < n){
							...
							switch(type)
							{
								...
								if(cp.length > 1){
									...
									u = '<a href="https://www.facebook.com/media/set/?set='+set[1]+'">'+st+'</a>';
									x = '';
									...
									z = item[o.text].replace(/\/l.php/gi,'https://www.facebook.com/l.php').replace(/href="\//gi,'href="https://www.facebook.com/');
								}
								break;
								...
								var v = [];
								v = parseQ(item.link);
								y = '<a href="'+q+'"><img src="https://img.youtube.com/vi/'+v['v']+'/'+o.thumb+'.jpg" alt="" /></a>';
								z = item.contentSnippet;
								...
								x = '';
								y = '<a href="'+q+'"><img src="' + item.images[o.thumb].url.replace('http:', '') + '" alt="" /></a>';
								...
								if(item.comments.count > 0 && o.comments > 0){
									...
									$.each(item.comments.data, function(i,cmt){
										if(o.comments > i){
											//m += '<span class="meta item-comments"><img src="'+cmt.from.profile_picture.replace('http:', '')+'" />';
								...
								if(item.likes.count > 0 && o.likes > 0){
									...
									$.each(item.likes.data, function(i,lk){
										if(o.likes > i){
											//if (lk.profile_picture.indexOf('anonymous') == -1) {
											//	m += '<img src="'+lk.profile_picture.replace('http:', '')+'" />';
											//}
											i++;
										} else {
											return false;
	...
	function nicetime(a,out){
		...
		function share(st,sq,twitterId){
			...
			s = '<a href="https://www.facebook.com/sharer.php?u='+sq+'&t='+st+'" class="share-facebook"></a>';
