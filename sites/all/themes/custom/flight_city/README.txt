...
http://foundation.zurb.com/docs/faq.php or use the script in the flight_city
...
----------------------------------
 1. Setup the location for your new sub-theme.
    ...
    Copy the flight_city folder out of the zurb_foundation/ folder and rename it to
    ...
    For example, copy the sites/all/themes/zurb_foundation/flight_city folder and
 ...
 2. Setup the basic information for your sub-theme.
    ...
    In your new sub-theme folder, rename the flight_cityKIT.info.txt file to include
    the name of your new sub-theme and remove the ".txt" extension. Then edit
    the .info file by editing the name and description field.

    For example, rename the foo/flight_city.info.txt file to foo/foo.info. Edit the
    foo.info file and change "name = Foundation Sub-theme flight_city" to
 ...
 3. Edit your sub-theme to use the proper function names.
    ...
    folder; replace ALL occurrences of "flight_city" with the name of your
    sub-theme.

    For example, edit foo/template.php and foo/theme-settings.php and replace
    every occurrence of "flight_city" with "foo".
